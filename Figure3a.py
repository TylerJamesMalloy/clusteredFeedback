...
sns.barplot(des[des['Experiment'] == "Experiment 1"], x='Name', y="Gap", hue="Environment", hue_order=["Immediate", "Clustered", "Aggregated"])

ax.set_title("RDEG Risky Choice Selection\nDifference by Timing of Feedback", fontsize=18)
